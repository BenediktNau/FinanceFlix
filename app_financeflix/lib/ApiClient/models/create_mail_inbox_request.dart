...
/// auto generated
class CreateMailInboxRequest implements AdditionalDataHolder, Parsable {
    ...
    ///  The useSsl property
    bool? useSsl;
    /// Instantiates a new [CreateMailInboxRequest] and sets the default values.
    CreateMailInboxRequest() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static CreateMailInboxRequest createFromDiscriminatorValue(ParseNode parseNode) {
        return CreateMailInboxRequest();
    }
