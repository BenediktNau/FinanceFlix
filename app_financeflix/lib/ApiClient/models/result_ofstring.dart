...
/// auto generated
class ResultOfstring implements AdditionalDataHolder, Parsable {
    ...
    ///  The value property
    String? value;
    /// Instantiates a new [ResultOfstring] and sets the default values.
    ResultOfstring() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static ResultOfstring createFromDiscriminatorValue(ParseNode parseNode) {
