...
/// auto generated
class UpdateTransactionRequest implements AdditionalDataHolder, Parsable {
    ...
    ///  The date property
    DateTime? date;
    /// Instantiates a new [UpdateTransactionRequest] and sets the default values.
    UpdateTransactionRequest() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static UpdateTransactionRequest createFromDiscriminatorValue(ParseNode parseNode) {
