...
/// auto generated
class CreateAccountRequest implements AdditionalDataHolder, Parsable {
    ...
    UntypedNode? balance;
    /// Instantiates a new [CreateAccountRequest] and sets the default values.
    CreateAccountRequest() :  
        additionalData = {};
    /// Creates a new instance of the appropriate class based on discriminator value
    ///  [parseNode] The parse node to use to read the discriminator value and create the object
    static CreateAccountRequest createFromDiscriminatorValue(ParseNode parseNode) {
